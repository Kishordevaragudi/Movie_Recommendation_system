...
* [Click here to run it live on server][(https://movie-recommeder-system.herokuapp.com/)](https://movierecommendationsystem-kmbe8qxpqgou4stjbepemk.streamlit.app/)
...
```bash
conda create -n movie python=3.9 -y
```
...
```bash
Author: kishore devaragudi
Email: kishordev36@gmail.com
